...
import logging
#'VERB_SCORE', 'DET_SCORE', 'ENGLISHV_SCORE', 'POSITION_RATIO','METHODV_SCORE'
stable_features = ['SPLIT_IDENTIFIER', 'WORD','NORMALIZED_POSITION', 'MAXPOSITION', 'CONTEXT_NUMBER'] #'LANGUAGE' 'PREP_SCORE'
mutable_feature_list = ['LAST_LETTER', 'NLTK_POS', 'CONSONANT_VOWEL_RATIO', 'POSITION', 'POSITION_RATIO', 'PREPOSITION', 'DETERMINER', 'CONTAINSDIGIT', 'CONTAINSCLOSEDSET', 'SECOND_LAST_LETTER', 'CONTAINSLISTVERB'] # 'ENGLISHN_SCORE' ,'ENGLISHPRE_SCORE'  'ENGLISHN_SCORE', 'METHODN_SCORE', 'METHODV_SCORE', 'CODEPRE_SCORE', 'ENGLISHV_SCORE', 'METHODPRE_SCORE', 'ENGLISHPRE_SCORE', 'CONJ_SCORE'
