...
mutable_feature_list = ['CONSONANT_VOWEL_RATIO', 'ENGLISHN_SCORE', 'NLTK_POS', 'MORPHOLOGICAL_PLURAL', 'ENGLISHV_SCORE', 'POSITION', 'MAXPOSITION', 'NORMALIZED_POSITION','POSITION_RATIO', 'VERB_SCORE', 'CONTAINSDIGITS', 'CONJ_SCORE'] # 'ENGLISHN_SCORE' ,'ENGLISHPRE_SCORE'  'ENGLISHN_SCORE', 'METHODN_SCORE', 'METHODV_SCORE', 'CODEPRE_SCORE', 'ENGLISHV_SCORE', 'METHODPRE_SCORE', 'ENGLISHPRE_SCORE', 'CONJ_SCORE'
