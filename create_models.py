...
stable_features = ['SPLIT_IDENTIFIER', 'WORD', 'MAXPOSITION', 'CONTEXT_NUMBER'] #'LANGUAGE' 'PREP_SCORE'
mutable_feature_list = ['ENGLISHV_SCORE', 'NORMALIZED_POSITION','POSITION_RATIO', 'POSITION', 'VERB_SCORE', 'CONTAINSDIGITS', 'CONTAINSVERB', 'CONTAINSCLOSEDSET', 'CONJ_SCORE'] # 'ENGLISHN_SCORE' ,'ENGLISHPRE_SCORE'  'ENGLISHN_SCORE', 'METHODN_SCORE', 'METHODV_SCORE', 'CODEPRE_SCORE', 'ENGLISHV_SCORE', 'METHODPRE_SCORE', 'ENGLISHPRE_SCORE', 'CONJ_SCORE'
